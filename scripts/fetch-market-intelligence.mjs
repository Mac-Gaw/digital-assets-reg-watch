...
const CORE_MARKET_TERMS = [
  ...
  "stablecoin", "stablecoins", "digital settlement asset", "tokenised deposit", "tokenized deposit",
  "deposit token", "bank-issued token", "bank issued token", "wholesale cbdc", "cbdc",
...
const CONTEXT_TERMS = [
  ...
  "financial market infrastructure", "fmi", "csd", "ccp", "collateral", "post-trade", "post trade", "wholesale",
...
const CATEGORY_RULES = [
  ...
  { category: "Stablecoins & settlement", terms: ["stablecoin", "stablecoins", "digital settlement asset", "tokenised deposit", "tokenized deposit", "bank-issued token", "bank issued token", "deposit token", "settlement asset"] },
